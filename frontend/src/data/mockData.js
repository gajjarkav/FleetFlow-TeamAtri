...
export const maintenance = [
    { id: 'M001', vehicleId: 'V003', type: 'Engine Overhaul', description: 'Full engine inspection and component replacement', status: 'in_progress', scheduledDate: '2026-02-15', completedDate: null, cost: 28000, workshop: 'Ashok Leyland Service Center, Ahmedabad', technician: 'Mohan Tekwani' },
    { id: 'M002', vehicleId: 'V008', type: 'Brake Replacement', description: 'Front and rear brake pad replacement', status: 'in_progress', scheduledDate: '2026-02-18', completedDate: null, cost: 8500, workshop: 'Mahindra Authorized Service, Surat', technician: 'Raju Vaishnav' },
    { id: 'M003', vehicleId: 'V001', type: 'Oil & Filter Change', description: 'Routine 10,000 km service', status: 'completed', scheduledDate: '2025-11-10', completedDate: '2025-11-10', cost: 3200, workshop: 'Tata ExPress Fleet, Ahmedabad', technician: 'Sanjay Parmar' },
    { id: 'M004', vehicleId: 'V002', type: 'Tyre Rotation', description: 'All four tyres rotated and balanced', status: 'completed', scheduledDate: '2025-09-22', completedDate: '2025-09-22', cost: 1800, workshop: 'MRF Tyre Point, Vadodara', technician: 'Anand Joshi' },
    { id: 'M005', vehicleId: 'V004', type: 'Transmission Service', description: 'Gearbox oil change and clutch inspection', status: 'completed', scheduledDate: '2025-12-01', completedDate: '2025-12-01', cost: 12500, workshop: 'Eicher Service, Ahmedabad', technician: 'Deepak Trivedi' },
    { id: 'M006', vehicleId: 'V005', type: 'Suspension Check', description: 'Full suspension system inspection – shock absorbers', status: 'scheduled', scheduledDate: '2026-03-05', completedDate: null, cost: 15000, workshop: 'BharatBenz Fleet Care, Surat', technician: 'N/A' },
    { id: 'M007', vehicleId: 'V006', type: 'CNG Kit Calibration', description: 'CNG pressure & kit calibration service', status: 'scheduled', scheduledDate: '2026-02-28', completedDate: null, cost: 4500, workshop: 'Force Motors CNG Center, Vadodara', technician: 'N/A' },
];
