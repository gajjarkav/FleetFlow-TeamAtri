...
import { maintenance as initialMaintenance, vehicles, getVehicleById } from '../data/mockData'
            ...
            <div className="table-container">
                ...
                <table>
                    ...
                    <tbody>
                            ...
                            return (
                                <tr key={r.id}>
                                    ...
                                    <td>
                                        ...
                                        <div style={{ fontSize: 11, color: 'var(--text-muted)' }}>{r.technician !== 'N/A' ? `Tech: ${r.technician}` : ''}</div>
                                    </td>
                        ...
                        {filtered.length === 0 && (
                            <tr><td colSpan={7} style={{ textAlign: 'center', padding: 40, color: 'var(--text-muted)' }}>No maintenance records found</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
